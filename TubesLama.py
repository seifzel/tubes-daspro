from list_operators import * # FUNGSI ANTARA
...
#   {MakeMatkul(nama, sks, listNilai) membuat objek Matkul dengan nama mata kuliah nama, jumlah SKS sks, dan list nilai listNilai
# REALISASI
